...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nric_no' => 'required|string|unique:students,nric_no,' . $this->route('student')->id . '|max:20',
    ...
    public function messages(): array
    {
        return [
            ...
            'nric_no.unique' => 'This NRIC/IC number is already registered to another student.',
